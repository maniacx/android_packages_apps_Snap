...
public class CameraControls extends RotatableLayout {
    ...
    private static final int METERING_MODE_INDEX = 13;
    ...
    private void markVisibility() {
        ...
        if (mMeteringSwitcher.getVisibility() == View.VISIBLE)
            mViewList.add(mMeteringSwitcher);
    ...
    public void onFinishInflate() {
        ...
        mMeteringSwitcher = findViewById(R.id.metering_switcher);
    ...
    private void setLocation(int w, int h) {
        ...
        toIndex(mMeteringSwitcher, w, h, rotation, 3, 0, METERING_MODE_INDEX);
    ...
    private void resetLocation(float x, float y) {
        ...
        mMeteringSwitcher.setX(mLocX[idx1][METERING_MODE_INDEX] + x);
        ...
        mMeteringSwitcher.setY(mLocY[idx1][METERING_MODE_INDEX] + y);
    ...
    public void setTitleBarVisibility(int status){
        ...
        mMeteringSwitcher.setVisibility(status);
        if(TsMakeupManager.HAS_TS_MAKEUP) {
    ...
    public void hideUI() {
        ...
        mMeteringSwitcher.animate().cancel();
        ...
        switch (rotation) {
            case 0:
                ...
                mMeteringSwitcher.animate().translationYBy(-mSize).setDuration(ANIME_DURATION);
            ...
            case 90:
                ...
                mMeteringSwitcher.animate().translationXBy(-mSize).setDuration(ANIME_DURATION);
    ...
    public void setOrientation(int orientation, boolean animation) {
        ...
        View[] views = {
            mSceneModeSwitcher, mFilterModeSwitcher, mMeteringSwitcher, mFrontBackSwitcher,
